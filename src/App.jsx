...
//       initial={{ opacity: 0 }}
//       animate={{ opacity: 1 }}
//       className="max-w-7xl mx-auto px-6 mt-12 text-gray-200"
//     >
...
//           animate={{ opacity: 1, y: 0 }}
//           className="p-6 bg-gray-900 border border-pink-500/30 rounded-xl shadow-lg flex justify-between items-center hover:shadow-pink-500/20 transition"
//         >
//           <div>
